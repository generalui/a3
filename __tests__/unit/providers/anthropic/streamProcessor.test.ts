...
describe('processAnthropicStream', () => {
  describe('chatbotMessage extraction', () => {
    it('should extract chatbotMessage and yield TEXT_MESSAGE_CONTENT deltas', async () => {
      ...
      const events = await collectEvents(processAnthropicStream(result, reader, first, 'test-agent', testSchema))
  ...
  describe('final response parsing', () => {
    ...
    it('should yield RUN_ERROR on schema validation failure', async () => {
      ...
      expect(errorEvent).toBeDefined()
      expect((errorEvent as { message: string }).message).toContain('Anthropic stream error')
    })
  })
  ...
  describe('error handling', () => {
    ...
    it('should yield RUN_ERROR when object promise rejects', async () => {
      const result = {
  ...
  describe('event metadata', () => {
    it('should include agentId on all TEXT_MESSAGE_CONTENT events', async () => {
      ...
      const events = await collectEvents(processAnthropicStream(result, reader, first, 'my-agent', testSchema))
